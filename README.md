...
本モデルの性能評価としてMNISTデータセットを使用して5-epoch学習をした結果、精度98.6% 損失4.2%となりました。
...
中間層にReLu，最終層でクラスごとのスコア（logits）を出力し，交差エントロピー損失を用いることで Softmax に基づく多クラス分類をおこなっています．
...
MNISTデータセットは60,000枚の学習用データと10,000枚のテスト用データで構成されるデータセットです.
