...
* $\boldsymbol{z}^{(1)}_k \in \mathbb{R}^{6 \times 28 \times 28}$ : 第1畳み込み層における $k$ 番目のチャンネルの畳み込み計算後の出力特徴マップ
...
* $\boldsymbol{h}^{(1)}_k \in \mathbb{R}^{6 \times 28 \times 28}$ :  $k$ 番目のチャンネルのReLU関数計算後の出力特徴マップ
...
* $\boldsymbol{z}^{(2)}_k \in \mathbb{R}^{16 \times 10 \times 10}$ : 第2畳み込み層における $k$ 番目のチャンネルの畳み込み計算後の出力特徴マップ
...
$$
* $\boldsymbol{h}^{(2)}_k \in \mathbb{R}^{16 \times 10 \times 10}$ :  $k$ 番目のチャンネルのReLU関数計算後の出力特徴マップ
...
* $\boldsymbol{p}^{(2)}_k \in \mathbb{R}^{16 \times 5 \times 5} $：第2プーリング層における $k$ 番目チャンネルの出力特徴マップ  
